...
mkdir data
cp -r /shared/projects/form_2022_32/coursLinux/rna-seq/01-Bioinfo/data/WT1* data/
cp -r /shared/projects/form_2022_32/coursLinux/rna-seq/01-Bioinfo/data/KO1* data/

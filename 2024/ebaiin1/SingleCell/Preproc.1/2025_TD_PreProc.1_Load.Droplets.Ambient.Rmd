...
-   An easy way is to **describe**, then **visualize** such effect.

-   In this purpose, we will use a whole series of `Seurat` functions, chained. 

-   You do not have to understand the meaning of such functions, just focus on
our purpose.

-   <I>The signification and usage of such functions will be the matter of the
practical sessions of the next few days</I>

...
-   **Questions** :
    ...
    -   Do you know a way to know what IS the type of object that was created ?
    ...
    -   Do you know a way to know what is the STRucture of the object that was created ?
...
-   **Question** : Is there something unexpected for the retained "TRUE" cells (red) in this kneeplot ?
...
-   **Question** : Should we try to remove such an amount of ambient RNA ?
...
-   **Questions** :
    ...
    3.  What are the features (genes) most affected by the soup removal (DEMO) ?
...
-   **Questions** : Can you compare the two plots :

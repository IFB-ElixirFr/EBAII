...
```{r permPeaks, warning=F,message=F,cache=T}
...
```{r plotHeatmapTSS, message=FALSE, warning=FALSE, include=TRUE}
...
```{r compareAnnot, eval=FALSE, fig.align=, message=FALSE, include=TRUE, out.width="50%"}
## Download GTF files
library(GenomicFeatures)

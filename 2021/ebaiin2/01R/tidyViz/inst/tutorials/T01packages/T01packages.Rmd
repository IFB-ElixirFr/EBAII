...
C'est le *repository* "originel" qui me à disposition (à l'heure où ce tutoriel a été écrit) 17618 packages. La liste de ces packages est disponible [ici](https://cran.r-project.org/web/packages/available_packages_by_name.html).
...
Le résultat depend de beaucoup de choses, y compris le système d'exploitation et la version de R que vous utilisez. Chez moi, le résultat est le suivant :

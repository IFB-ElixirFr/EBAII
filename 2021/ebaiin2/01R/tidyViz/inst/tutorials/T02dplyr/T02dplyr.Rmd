...
Utilisez la fonction `summarise` pour créer la table `EnergieQuartiles`. N'oubliez pas de consulter l'aide de la fonction `summarise` pour vous guider.
...
# puis summarise pour résumer
# avec quantile pour calculer les quartiles
```

...
<details>
  <summary style="color: DarkCyan"> Show code: barplot </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: load ggplot2 </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: create the data.frame </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: barplot with ggplot2 </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: color according to the chipped TF (column IP) </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: color according to the chipped TF (column IP) and set RColorBrewer palette to Set1 </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: Display peak length statistics </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: Display peak length statistics as a boxplot </summary>
...
<details>
  <summary style="color: DarkCyan"> Show code: Display peak length statistics with ggplot2 </summary>
...
<details>
  <summary style="color: DarkCyan">Enhance it !</summary>
...
<details>
  <summary style="color: DarkCyan">Show the code: select high quality peaks</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: annotate BRG1 peaks</summary>
...
<details>
  <summary style="color: DarkCyan">Expand to find Coturnix japonica example</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Display peak distribution of genomic features</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: compute the peak centers </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: order and select peaks </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Create GRanges object with peak center </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: resize the peak regions </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: create the matrix and display the heatmap </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Extend 5000bp from TSS and create the matrix </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Plot the average profile of BRG1 binding </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Create all peak center GRanges object and extend them </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Create the read enrichment matrix </summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Read MITF and SOX10 peak files</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Plot peak set size per TF</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: create a data.frame containing all peak widths</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: plot the distribution on peak length per experiment</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: annotate the peaks</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: Plot genomic feature distribution per experiment</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: plot expression distribution in both condition</summary>
...
<details>
  <summary style="color: DarkCyan">Show code: plot significantly differentially expressed genes in clusters</summary>
